...
public class MultiVaLCA {
	...
	private String versionString ="Version 0.8";
	private String dateString ="29.07.2021";
	...
	private final Action ErgebnisseExport 		= new ErgebnisseExport (l);
...
//		LANGUAGES.put(Language.Hrvatski, kroatisch);
	...
	private void initialize() {
		...
		JMenuItem AAA = new JMenuItem();
		AAA.setAction(ErgebnisseExport ); 			//Ergebnisse Export
		AAA.setFont(generalfont);
		AAA.setText("Ergebnisse Export");
		mnBerechnen.add(AAA);	
