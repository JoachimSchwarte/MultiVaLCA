...
class ModuleGroupTest {
	...
	void testS123m2() {
		...
		Group123.addFlowValueMap(Modul2);
		Group123.addFlowValueMap(Modul3);
		S123m2.addProzessmodul(Group123);
		S123m2.addProzessmodul(Modul4);	
		Group123.disableEntry(Modul2);
		LinkedHashMap<Flow, LinkedHashMap<ValueType, Double>> efv = S123m2.getElementarflussvektor();
		LinkedHashMap<ValueType, Double> vv = efv.get(r1);
		assertEquals(-725., vv.get(ValueType.MeanValue), .001);
		assertEquals(-754.51, vv.get(ValueType.LowerBound), .001);
		assertEquals(-696.34, vv.get(ValueType.UpperBound), .001);
		...
		assertEquals(695.01, vv.get(ValueType.LowerBound), .001);
		assertEquals(705.01, vv.get(ValueType.UpperBound), .001);
		Group123.enableEntry(Modul2);
		efv = S123m2.getElementarflussvektor();
		vv = efv.get(r1);
		assertEquals(-716.6666, vv.get(ValueType.MeanValue), .001);
		assertEquals(-754.51, vv.get(ValueType.LowerBound), .001);
		assertEquals(-695.02, vv.get(ValueType.UpperBound), .001);
	...
	void testS123m3() {
		...
		Group123.addFlowValueMap(Modul2);
		Group123.addFlowValueMap(Modul3);
		S123m3.addProzessmodul(Group123);
		S123m3.addProzessmodul(Modul4);	
		Group123.disableEntry(Modul3);
		LinkedHashMap<Flow, LinkedHashMap<ValueType, Double>> efv = S123m3.getElementarflussvektor();
		LinkedHashMap<ValueType, Double> vv = efv.get(r1);
		assertEquals(-725., vv.get(ValueType.MeanValue), .001);
		assertEquals(-754.51, vv.get(ValueType.LowerBound), .001);
		assertEquals(-695.02, vv.get(ValueType.UpperBound), .001);
		...
		assertEquals(695.01, vv.get(ValueType.LowerBound), .001);
		assertEquals(807.02, vv.get(ValueType.UpperBound), .001);
		Group123.enableEntry(Modul3);
		efv = S123m3.getElementarflussvektor();
		vv = efv.get(r1);
		assertEquals(-716.6666, vv.get(ValueType.MeanValue), .001);
		assertEquals(-754.51, vv.get(ValueType.LowerBound), .001);
		assertEquals(-695.02, vv.get(ValueType.UpperBound), .001);
	...
	void testS123m12() {
		...
		Group123.addFlowValueMap(Modul2);
		Group123.addFlowValueMap(Modul3);
		S123m12.addProzessmodul(Group123);
		S123m12.addProzessmodul(Modul4);	
		Group123.disableEntry(Modul1);
		Group123.disableEntry(Modul2);
		LinkedHashMap<Flow, LinkedHashMap<ValueType, Double>> efv = S123m12.getElementarflussvektor();
		LinkedHashMap<ValueType, Double> vv = efv.get(r1);
		assertEquals(-700., vv.get(ValueType.MeanValue), .001);
		assertEquals(-703.6733, vv.get(ValueType.LowerBound), .001);
		assertEquals(-696.34, vv.get(ValueType.UpperBound), .001);
		...
		assertEquals(704.6733, vv.get(ValueType.UpperBound), .001);
		Group123.enableEntry(Modul1);
		efv = S123m12.getElementarflussvektor();
		vv = efv.get(r1);
		assertEquals(-725., vv.get(ValueType.MeanValue), .001);
		assertEquals(-754.51, vv.get(ValueType.LowerBound), .001);
		assertEquals(-696.34, vv.get(ValueType.UpperBound), .001);
	...
	void testS123m13() {
		...
		Group123.addFlowValueMap(Modul2);
		Group123.addFlowValueMap(Modul3);
		S123m13.addProzessmodul(Group123);
		S123m13.addProzessmodul(Modul4);	
		Group123.disableEntry(Modul1);
		Group123.disableEntry(Modul3);
		LinkedHashMap<Flow, LinkedHashMap<ValueType, Double>> efv = S123m13.getElementarflussvektor();
		LinkedHashMap<ValueType, Double> vv = efv.get(r1);
		assertEquals(-700., vv.get(ValueType.MeanValue), .001);
		assertEquals(-705.02, vv.get(ValueType.LowerBound), .001);
		assertEquals(-695.02, vv.get(ValueType.UpperBound), .001);
		...
		assertEquals(807.02, vv.get(ValueType.UpperBound), .001);
		Group123.enableEntry(Modul1);
		efv = S123m13.getElementarflussvektor();
		vv = efv.get(r1);		
		assertEquals(-725., vv.get(ValueType.MeanValue), .001);
		assertEquals(-754.51, vv.get(ValueType.LowerBound), .001);
		assertEquals(-695.02, vv.get(ValueType.UpperBound), .001);
	...
	void testS123m23() {
		...
		Group123.addFlowValueMap(Modul2);
		Group123.addFlowValueMap(Modul3);
		S123m23.addProzessmodul(Group123);
		S123m23.addProzessmodul(Modul4);	
		Group123.disableEntry(Modul2);
		Group123.disableEntry(Modul3);
		LinkedHashMap<Flow, LinkedHashMap<ValueType, Double>> efv = S123m23.getElementarflussvektor();
		LinkedHashMap<ValueType, Double> vv = efv.get(r1);
		assertEquals(-750., vv.get(ValueType.MeanValue), .001);
		assertEquals(-754.51, vv.get(ValueType.LowerBound), .001);
		assertEquals(-745.51, vv.get(ValueType.UpperBound), .001);
		...
		assertEquals(705.01, vv.get(ValueType.UpperBound), .001);
		Group123.enableEntry(Modul2);
		efv = S123m23.getElementarflussvektor();
		vv = efv.get(r1);
		assertEquals(-725., vv.get(ValueType.MeanValue), .001);
		assertEquals(-754.51, vv.get(ValueType.LowerBound), .001);
		assertEquals(-695.02, vv.get(ValueType.UpperBound), .001);
