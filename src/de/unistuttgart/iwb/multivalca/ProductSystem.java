...
implements FlowValueMaps, ImpactValueMaps {
	...
	private void aktualisiere() throws Exception {
		...
		try {
/*			System.out.println();
			System.out.println("A[1,1] = "+imA.getValue(0, 0).getLowerBound());
			System.out.println("A[1,2] = "+imA.getValue(0, 1).getLowerBound());
			System.out.println("A[2,1] = "+imA.getValue(1, 0).getLowerBound());
			System.out.println("A[2,2] = "+imA.getValue(1, 1).getLowerBound());
			System.out.println("B[1]   = "+ivF.getValue(0).getLowerBound());
			System.out.println("B[2]   = "+ivF.getValue(1).getLowerBound());      */
			ivS = imA.gauss(ivF);
/*			System.out.println("S[1]   = "+ivS.getValue(0).getLowerBound());
			System.out.println("S[2]   = "+ivS.getValue(1).getLowerBound());      */
		} catch (Exception e) {
